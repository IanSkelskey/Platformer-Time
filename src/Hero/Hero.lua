...
self.animations = {
  ...
  ['skid'] = newAnimation(love.graphics.newImage("images/finn_turn.png"), 32, 32, .4),      -- CHANGE SKID: tween to top speed when you press the run button and only skid from top speed (sprint state)
